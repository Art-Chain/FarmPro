...
export const AppShell = ({
  ...
  return (
    <AnimatedScrollView onScroll={handler} style={{ minHeight: frame.height }}>
      <View style={headerSizeStyle}/>
      <View style={[contentContainerStyle, { minHeight: frame.height - height }]}>
        {children}
        <Space size={height}/>
      </View>
      {!!footer && (
        ...
        >
          <BlurView style={[footerBlurStyle]} blurType={'transparent'} blurAmount={16}/>
          {footer}
