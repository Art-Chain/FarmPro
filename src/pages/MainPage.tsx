...
import { HomePage, UserPage } from '@/pages/main';
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size, focused }) => {
          if (focused) {
            ...
            else if (route.name === 'contentList') return <ArticleFillIcon width={size} height={size} color={color}/>;
          ...
          else if (route.name === 'contentList') return <ArticleIcon width={size} height={size} color={color}/>;
        ...
        tabBarLabel: route.name === 'home' ? '홈' : route.name === 'contentList' ? '기록' : '마이팜프로',
        headerShown: false,
      })}
    >
      <Tab.Screen name={'home'} component={HomePage}/>
      <Tab.Screen name={'contentList'} component={ContentListPage}/>
